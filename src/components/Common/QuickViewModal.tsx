          ...
          <div className="flex flex-wrap items-center gap-12.5">
            ...
            <div className="max-w-[445px] w-full">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <div className="flex items-center gap-1">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <svg
                        key={star}
                        className={star <= 4 ? "fill-[#FFA645]" : "fill-gray-4"}
                        width="18"
                        height="18"
                        viewBox="0 0 18 18"
                        fill="none"
                  ...
                  <span>
                    ...
                    <span className="text-dark-2">({product.reviews || 5} {t.reviews})</span>
                  </span>
                </div>
              ...
              <p className="text-dark-3">
                {product.description || "Sản phẩm nội thất gỗ cao cấp, thiết kế tinh tế, chất lượng vượt trội. Phù hợp với nhiều phong cách nội thất hiện đại."}
              </p>
