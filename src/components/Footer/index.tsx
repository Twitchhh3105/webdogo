...
const Footer = () => {
  ...
  return (
    <footer className="overflow-hidden border-t border-gray-3 bg-white">
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            <h2 className="mb-7.5 text-custom-1 font-semibold text-dark">
              {t.helpAndSupport}
            </h2>
            ...
            <ul className="flex flex-col gap-4">
              <li className="flex gap-4.5">
                ...
                <span className="text-dark-4 text-custom-sm leading-relaxed">
                  {t.footerAddress}
                </span>
              </li>

              <li>
                <a href="tel:+84123456789" className="flex items-center gap-4.5 hover:text-blue transition-colors">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                  ...
                  <span className="text-dark-4 text-custom-sm">(+84) 123 456 789</span>
                </a>
              </li>

              <li>
                <a href="mailto:support@neuronest.vn" className="flex items-center gap-4.5 hover:text-blue transition-colors">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                  ...
                  <span className="text-dark-4 text-custom-sm">support@neuronest.vn</span>
                </a>
              </li>
            </ul>
            ...
            <div className="flex items-center gap-4 mt-7.5">
              ...
              <div className="flex items-center gap-4 mt-7.5">
                <a
                  ...
                  aria-label="Facebook"
                  className="w-9 h-9 flex items-center justify-center rounded-full border border-gray-3 text-dark-4 hover:border-blue hover:text-white hover:bg-blue transition-all"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5">
              <li>
                <Link className="text-dark-4 text-custom-sm hover:text-blue transition-colors" href="/my-account">
                  {t.myAccount}
                </Link>
              </li>
              <li>
                <Link className="text-dark-4 text-custom-sm hover:text-blue transition-colors" href="/signin">
                  {t.login} / {t.register}
                </Link>
              </li>
              <li>
                <Link className="text-dark-4 text-custom-sm hover:text-blue transition-colors" href="/cart">
                  {t.cart}
                </Link>
              </li>
              <li>
                <Link className="text-dark-4 text-custom-sm hover:text-blue transition-colors" href="/wishlist">
                  {t.wishlist}
                </Link>
              </li>
              <li>
                <Link className="text-dark-4 text-custom-sm hover:text-blue transition-colors" href="/shop">
                  {t.shop}
                </Link>
              </li>
            </ul>
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5">
              <li>
                <Link className="text-dark-4 text-custom-sm hover:text-blue transition-colors" href="/privacy-policy">
                  {t.privacyPolicy}
                </Link>
              </li>
              <li>
                <Link className="text-dark-4 text-custom-sm hover:text-blue transition-colors" href="/refund-policy">
                  {t.returnPolicy}
                </Link>
              </li>
              <li>
                <Link className="text-dark-4 text-custom-sm hover:text-blue transition-colors" href="/terms">
                  {t.termsConditions}
                </Link>
              </li>
              <li>
                <Link className="text-dark-4 text-custom-sm hover:text-blue transition-colors" href="/faq">
                  {t.faq}
                </Link>
              </li>
              <li>
                <Link className="text-dark-4 text-custom-sm hover:text-blue transition-colors" href="/contact">
                  {t.contact}
                </Link>
              </li>
            </ul>
          ...
          <div className="w-full sm:w-auto">
            <h2 className="mb-7.5 text-custom-1 font-semibold text-dark lg:text-right">
              {t.downloadApp}
            </h2>

            <p className="lg:text-right text-dark-4 text-custom-sm mb-6">
              {t.appOffer}
            </p>
            ...
            <ul className="flex flex-col lg:items-end gap-3">
              <li>
                <a
                  className="flex items-center gap-3 py-2.5 px-5 text-white rounded-lg bg-dark hover:bg-black transition-colors min-w-[170px]"
                  href="#"
                >
                  <svg
                  ...
                  <div className="text-left">
                    <span className="block text-2xs uppercase tracking-wider opacity-80">
                      {t.downloadOn}
                    </span>
              ...
              <li>
                <a
                  className="flex items-center gap-3 py-2.5 px-5 text-white rounded-lg bg-blue hover:bg-opacity-90 transition-colors min-w-[170px]"
                  href="#"
                >
                  <svg
                    className="fill-current"
                  ...
                  <div className="text-left">
                    <span className="block text-2xs uppercase tracking-wider opacity-80"> {t.getInOn} </span>
      ...
      {/* <!-- footer bottom start --> */}
      <div className="py-6 bg-gray-1 border-t border-gray-3">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-6 flex-wrap items-center justify-between">
            <p className="text-dark-4 text-custom-sm font-medium">
              &copy; {year} {t.allRightsReserved} - Neuronest Furniture.
            </p>

            <div className="flex flex-wrap items-center gap-5">
              <p className="text-dark font-semibold text-custom-sm italic">{t.weAccept}</p>

              <div className="flex flex-wrap items-center gap-4 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all">
                {[
                  { src: "/images/payment/payment-01.svg", alt: "visa", w: 45, h: 15 },
                  { src: "/images/payment/payment-02.svg", alt: "paypal", w: 15, h: 18 },
                  { src: "/images/payment/payment-03.svg", alt: "mastercard", w: 25, h: 18 },
                  { src: "/images/payment/payment-04.svg", alt: "applepay", w: 40, h: 18 },
                  { src: "/images/payment/payment-05.svg", alt: "googlepay", w: 45, h: 18 }
                ].map((payment, i) => (
                  <Image
                    key={i}
                    src={payment.src}
